...
class BottomDrawer extends PureComponent {
    ...
    productHandler = () => {
        this.props.context.addProduct(this.props.product);
        this.props.toggle();
    }
        ...
        return (
            <SwipeableDrawer anchor="bottom" open={this.props.show} onOpen={() => console.log("im open")} onClose={this.props.toggle} >
                <div className="bottom-drawer-content">
                    <Consumer>
                        {context => <ProductCard title="Product only" img={this.props.product.img} price={this.props.product.price} clicked={this.productHandler} />}
                    </Consumer>
